...
CXXFLAGS =  -g -std=c++17 -MMD -Wall -I. -I$(RPC) -DLAB=$(LAB) -DSOL=$(SOL) -D_FILE_OFFSET_BITS=64 -Wfatal-errors
...
yfs_client=yfs_client.cc extent_client.cc fuse.cc log.cc
ifeq ($(LAB3GE),1)
...
extent_server=extent_server.cc extent_smain.cc log.cc
